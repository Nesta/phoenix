			...
			if(node == "pre"){
				...
				if(!o.parent().hasClass("snippet-wrap")){
					...
					var controls = "<div class='snippet-menu sh_sourceCode' style='display:none;'><pre>"
								  ...
								  +"<a class='snippet-text' href='#'>Raw Text</a>"
					...
					o.parent().find("a.snippet-text").click(function(){
            					$(this).closest('.snippet-container').find(".sh_html ol").toggleClass('snippet-num');
						var txt = $(this);//.parents('.snippet-wrap').find('.snippet-text');
						//txt.toggle();
           					if (aux != '0'){
							txt.html("Raw Text");
					                aux = '0';
